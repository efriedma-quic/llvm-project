...
void AArch64_MC::initLLVMToCVRegMapping(MCRegisterInfo *MRI) {
  ...
  static const struct {
    ...
    MCPhysReg Reg;
      ...
      // FIXME: Temporarily map Z/P registers using Q register IDs until we
      ...
      {codeview::RegisterId::ARM64_Q0, AArch64::P0},
      {codeview::RegisterId::ARM64_Q1, AArch64::P1},
      {codeview::RegisterId::ARM64_Q2, AArch64::P2},
      {codeview::RegisterId::ARM64_Q3, AArch64::P3},
      {codeview::RegisterId::ARM64_Q4, AArch64::P4},
      {codeview::RegisterId::ARM64_Q5, AArch64::P5},
      {codeview::RegisterId::ARM64_Q6, AArch64::P6},
      {codeview::RegisterId::ARM64_Q7, AArch64::P7},
      {codeview::RegisterId::ARM64_Q8, AArch64::P8},
      {codeview::RegisterId::ARM64_Q9, AArch64::P9},
      {codeview::RegisterId::ARM64_Q10, AArch64::P10},
      {codeview::RegisterId::ARM64_Q11, AArch64::P11},
      {codeview::RegisterId::ARM64_Q12, AArch64::P12},
      {codeview::RegisterId::ARM64_Q13, AArch64::P13},
      {codeview::RegisterId::ARM64_Q14, AArch64::P14},
      {codeview::RegisterId::ARM64_Q15, AArch64::P15},
  };
